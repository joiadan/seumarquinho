...
[122.6K](https://github.com/firecrawl/firecrawl) [Sign up](https://www.firecrawl.dev/signin?view=signup)
...
1[\
2  {\
3    "url": "Z0!0?--*exaap*-.c9m",\
4    "markdown": "? =et00ng St=rZ!*-Z.",\
5    "json": { "title": "*u?Ze", "docs": "..." },\
6    "screenshot": "htt?0:?/ex00pae-a!-Z!!--.png"\
7  }\
8]
```
...
![User](https://www.firecrawl.dev/_next/image?url=%2Fassets-original%2Ffeatures%2Fcached-user.png&w=256&q=75&dpl=dpl_Ddzm9V77Ptyz9PvdUFgDYKkApmNA)

User

Firecrawl

![Cache](https://www.firecrawl.dev/_next/image?url=%2Fassets-original%2Ffeatures%2Fcached-cache.png&w=128&q=75&dpl=dpl_Ddzm9V77Ptyz9PvdUFgDYKkApmNA)![Cache](https://www.firecrawl.dev/_next/image?url=%2Fassets-original%2Ffeatures%2Fcached-cache-color.png&w=128&q=75&dpl=dpl_Ddzm9V77Ptyz9PvdUFgDYKkApmNA)

![Web](https://www.firecrawl.dev/_next/image?url=%2Fassets-original%2Ffeatures%2Fcached-web.png&w=128&q=75&dpl=dpl_Ddzm9V77Ptyz9PvdUFgDYKkApmNA)![Web](https://www.firecrawl.dev/_next/image?url=%2Fassets-original%2Ffeatures%2Fcached-web-color.png&w=128&q=75&dpl=dpl_Ddzm9V77Ptyz9PvdUFgDYKkApmNA)
...
Firecrawl is free for 1,000 pages every month (1,000 free credits per month). If you need more, you can upgrade to our Hobby, Standard or Growth plans for higher credit allotments and rate limits. AI agents can get started using the onboarding skill at https://www.firecrawl.dev/agent-onboarding/SKILL.md which handles signup and API key creation in one smooth flow.
...
[Playground](https://www.firecrawl.dev/playground) [Pricing](https://www.firecrawl.dev/pricing) [Templates](https://github.com/orgs/firecrawl/repositories?q=sort%3Astars) [Changelog](https://www.firecrawl.dev/changelog) [Free Tools](https://www.firecrawl.dev/tools)
