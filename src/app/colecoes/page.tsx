      ...
      <header className="fixed top-0 left-0 right-0 w-full z-45 bg-white/80 backdrop-blur-md border-b border-[#e5e5e5] transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-14 md:h-20 flex justify-between items-center">
          ...
          >
            ...
            <span className="font-display font-extrabold text-[15px] md:text-2xl tracking-tighter text-[#1a1a1a] hover:text-[#c9a830] transition-colors uppercase">
              Seu Marquinho
            </span>
          </Link>
          ...
          <div className="flex items-center gap-1 md:gap-6">
            <button
              ...
              className="hover:scale-110 transition-all duration-300 active:scale-95 text-[#1a1a1a] cursor-pointer p-1.5 md:p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center"
            ...
            <button
              ...
              className="hover:scale-110 transition-all duration-300 active:scale-95 text-[#1a1a1a] relative cursor-pointer p-1.5 md:p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center"
              aria-label="Carrinho"
            >
              ...
              {cartCount > 0 && (
                <motion.span
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  className="absolute top-0 right-0 md:-top-1.5 md:-right-1.5 bg-[#d30017] text-[#ffe2de] text-[9px] md:text-[10px] w-4 h-4 md:w-4.5 md:h-4.5 flex items-center justify-center rounded-full font-bold border border-white"
                >
                  {cartCount}
                </motion.span>
              )}
            ...
            <button
              ...
              className="md:hidden p-1.5 text-[#1a1a1a] hover:text-[#c9a830] cursor-pointer min-w-[44px] min-h-[44px] flex items-center justify-center"
              aria-label="Menu"
            >
              {isMobileMenuOpen ? (
                <X className="w-5 h-5" />
        ...
        <section className="py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-10">
            ...
            <motion.div 
              ...
              className="mb-12 grid grid-cols-1 lg:grid-cols-12 gap-0 items-stretch bg-white border border-[#e5e5e5] overflow-hidden relative shadow-sm"
            >
              ...
              <div className="lg:col-span-7 relative h-[300px] md:h-[450px] w-full bg-[#fafafa] overflow-hidden flex items-center justify-center">
                ...
                {/* Left - Cinza */}
                <motion.div 
                  className="absolute z-10 w-[35%] md:w-[35%] -translate-x-[55%] md:-translate-x-[80%] -rotate-12 opacity-70 hover:opacity-100 drop-shadow-xl"
